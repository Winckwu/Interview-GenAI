...
- I017（律师）: 需要追踪推理过程以信任结果
- I026（医疗）: 必须理解AI如何得出建议
...
**为什么I017（律师）和I26（医疗）需要这个**：
- 客户信息（高重要+法律风险）：最小干预，最大验证
- 法律框架（熟悉领域）：中等干预，中等验证
...
- I17（律师）: **"不能输入客户信息"** - 职业伦理禁止
- I26（医疗）: **"HIPAA合规要求"** - 法律约束
