...
export const STRUGGLING_USERS: MockUserProfile[] = [
  ...
  },
  {
    ...
    independenceRate: 0.45,
    taskCount: 8,
    contextAware: true // Context-aware but struggling with adaptation
  },
  {
    userId: 'str_008',
    userName: '范丽',
  ...
  },
  {
    ...
    independenceRate: 0.42,
    taskCount: 8,
    contextAware: true // Pattern C that switches strategies
  }
];
...
export const EXPECTED_DETECTIONS: Record<string, string> = {
  ...
  'eff_001': 'A', // High verification
  'eff_002': 'A', // Very high verification
  'eff_003': 'B', // Multiple queries with verification
  ...
  'str_005': 'B', // Some verification but lower
  'str_006': 'B', // Some verification but lower
  'str_007': 'C', // Might be misclassified as B without context awareness
  'str_008': 'C', // Might be misclassified as B without context awareness
  'str_009': 'A', // Pattern A with good verification
  'str_010': 'C'  // Pattern C with context switching
};
