...
> **重要说明**：访谈样本中模式F仅有2例(4.1%)，这是由于访谈研究的自选择偏差。真实课堂数据(N=378)显示模式F占比高达39.2%。
...
**占比**：4.1% (2/49: I30, I44)
**真实数据对比**：39.2% (148/378) - 真实课堂数据显示模式F远比访谈样本更普遍
**元认知特征**：低规划、低监控、低评价、低调节
**核心问题**：无意识的能力退化 + 虚假生产力

> **关键发现**：访谈样本中模式F仅2例，这是由于**自选择偏差**——愿意参与研究的用户通常具备较高元认知意识。真实课堂数据显示模式F实际占比高达39.2%。
>
> **模式F代表**：
