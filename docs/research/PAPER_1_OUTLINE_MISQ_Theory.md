...
|---------|------|----------|---------|
| A: 战略性分解与控制 | 20.4% | 高自主、低接受率 | "我有明确的边界" |
| B: 迭代优化与校准 | 10.2% | 快速迭代、质量敏感 | "时间就是金钱" |
| C: 情境敏感的适配 | 44.9% | 情境适应、灵活性 | "看情况决定" |
| D: 深度核验与批判性介入 | 18.4% | 高验证、批判思维 | "必须验证" |
| E: 教学化反思与自我监控 | 2.0% | 高澄清、资源查阅 | "为什么这样" |
| F: 元认知缺位与被动依赖 | 4.1% | 过度信任、低意识 | "AI肯定对" |
```
